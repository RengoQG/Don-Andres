...
const Dream = () => {
  return (
    <section className="swiper-container-horizontal section section-sm bg-default text-md-left">
      <div className="container">
        <div className="row row-50 align-items-center justify-content-center justify-content-xl-between">
          <div className="col-lg-6 col-xl-5 wow fadeInLeft">
            ...
            {/* Bootstrap tabs*/}
            <div
              className="tabs-custom tabs-line tabs-line-big text-center text-md-left"
              id="tabs-6"
            >
              {/* Nav tabs*/}
              ...
              <div className="tab-content">
                <div className="tab-pane fade show active" id="tabs-6-1">
                  ...
                  <p>
                    ...
                    Voluptatum iusto eaque modi debitis sed earum voluptas in
                    assumenda minima incidunt..
                  </p>
                ...
                <div className="tab-pane fade" id="tabs-6-2">
                  ...
                  <p>
                    ...
                    you to stay connected to your accounts on Facebook,
                    Instagram, Twitter and other networks.
                  </p>
                  <div className="group-sm group-middle">
                    <a
                      className="button button-secondary button-pipaluk"
                ...
                <div className="tab-pane fade" id="tabs-6-3">
                  ...
                  <p>
                    Every customer of RatherApp can get access to our friendly
                    and qualified 24/7 support via chat or phone. Fell free to
                    ask us any question!
                  </p>
                  <div className="group-sm group-middle">
                    <a
                ...
                <div className="tab-pane fade" id="tabs-6-4">
                  ...
                  <p>
                    All our apps are designed to have great usability in order
                    to easily operate our applications. That is why our software
                    has high ratings and lots of awards.
                  </p>
                  <div className="group-sm group-middle">
                    <a
                      className="button button-secondary button-pipaluk"
          ...
          >
            ...
            >
              <a className="box-device" href="#">
                <img src="images/teclado.jpg" alt="" width="313" height="580" />
              </a>
              <a className="box-device" href="#">
                <img
                  src="images/teclado2.jpg"
                  alt=""
                  width="313"
                  height="580"
                />
